...
public static class BrandAssets
{
    ...
    public const string LogoFileName = "hssgm-logo.png";
    ...
    public static Stream OpenLogoStream()
    {
        ...
        var outputPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Assets", LogoFileName);
        if (File.Exists(outputPath))
            return File.OpenRead(outputPath);

        throw new FileNotFoundException("HSSGM logosu bulunamadı.", LogoFileName);
    }
}
